![](https://skills.syvixor.com/api/icons?i=c,csharp,java,js,ts,mysql,html,css,svg,md,threejs,react,tailwind,spring,npm,git,ws,regex,postgresql,leetcode,github,vscode,blender,figma,obsidian,premierepro,photoshop,excel)
