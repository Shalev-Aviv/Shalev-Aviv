![](https://skills.syvixor.com/api/icons?i=c,csharp,java,js,ts,mysql,html,css,svg,md,threejs,react,tailwind,spring,npm,git,ws,regex,postgresql,leetcode,github,claudeai,vscode,blender,figma,obsidian,premierepro,photoshop,excel)

<!--
![](https://skills.syvixor.com/api/icons?i=ts,supabase,nextjs,graphql,docker,prisma,tauri,rust,electron)
-->
